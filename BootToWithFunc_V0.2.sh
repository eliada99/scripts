...
function displayMainMenu
{
	...
	echo "---Enter 100 for iall servers - Need to implementation --"
	echo "---------------------------------------------------------"
	...
	echo "---------------------------------------------------------"
        echo "---------------HP Servers--------------------------------"
	echo "---Enter 23 for - IP: pxehp87 (GEN 10)                 --"
	echo "---Enter 24 for - IP: pxehp206 (HPE Gen10)             --"
	...
	#echo "---Enter 55 for - IP:          --"
	#echo "---Enter 56 for - IP:          --"
	#echo "---Enter 57 for - IP:          --"
